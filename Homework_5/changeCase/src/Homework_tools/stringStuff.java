...
public class stringStuff {
    ...
    // if needed to in sensitive for state of letter case, upper function can be used .
    public static String squeeze(String a , String b)
    {
        ...
        for(char A : a.toCharArray())
         ...
         //note for myself this is a class so dont forget! Turn it into string object to return...       
